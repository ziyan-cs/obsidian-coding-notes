...
> [!important] **核心考点**
> 临界区与竞态条件、锁的实现（Peterson/硬件原子/自旋锁）、互斥锁 vs 自旋锁
...
进阶话题见 → [信号量](01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/05-Synchronization（同步与互斥⭐）/02-Semaphore（信号量）.md) · [死锁](01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/05-Synchronization（同步与互斥⭐）/03-Deadlock（死锁）.md)
