...
计算机架构与抽象详见 → [Hardware vs Software（软硬件关系）](/01-CS%20Core%20(计算机核心基础)/01%20·%20Computer%20Fundamentals（计算机基础）/01-Computer%20Overview（计算机系统总览）/02-Hardware%20vs%20Software（软硬件关系）.md) · [System Abstraction（系统抽象层次）](/01-CS%20Core%20(计算机核心基础)/01%20·%20Computer%20Fundamentals（计算机基础）/01-Computer%20Overview（计算机系统总览）/03-System%20Abstraction（系统抽象层次）.md)
