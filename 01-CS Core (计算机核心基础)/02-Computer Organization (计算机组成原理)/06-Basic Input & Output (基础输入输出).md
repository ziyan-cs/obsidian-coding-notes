...
> [!important] **核心考点**：I/O 三种方式（程序控制/中断/DMA）、中断处理流程、DMA 传输机制
...
总线系统与CPU执行模型详见 → [Bus System（总线系统）](/01-CS%20Core%20(计算机核心基础)/02-Computer%20Organization%20(计算机组成原理)/05-Bus%20System%20(总线系统).md) · [CPU Execution Model（CPU执行模型）](/01-CS%20Core%20(计算机核心基础)/02-Computer%20Organization%20(计算机组成原理)/01-CPU%20Execution%20Model%20(CPU执行模型).md)
