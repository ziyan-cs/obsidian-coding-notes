...
> [!important] **核心考点**：MySQL C API 连接池实现、连接复用与并发控制、连接池参数调优
...
MySQL基础连接配置见 → [MySQL Basics (MySQL 基础)](/06-Database%20(数据库)/01-SQL%20Fundamentals%20(SQL%20基础)/02-MySQL%20Basics%20(MySQL%20基础).md)
