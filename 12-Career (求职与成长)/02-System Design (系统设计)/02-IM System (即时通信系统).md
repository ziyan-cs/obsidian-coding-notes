...
> [!summary] 核心摘要
> IM 系统用长连接网关维护在线会话，用消息序号和持久化保证可追赶投递。设计要区分单聊群聊、在线离线、多端同步，并明确重复、乱序和断线重连语义。
...
关联：[HTTP Protocol (HTTP 协议)](/06-Systems%20and%20Networking%20(系统与网络)/02-Network%20Protocols%20(网络协议)/06-HTTP%20Protocol%20(HTTP%20协议).md) · [Reactor Architecture (Reactor 架构)](/06-Systems%20and%20Networking%20(系统与网络)/03-Server%20Networking%20(服务器网络编程)/02-Reactor%20Architecture%20(Reactor%20架构).md)
