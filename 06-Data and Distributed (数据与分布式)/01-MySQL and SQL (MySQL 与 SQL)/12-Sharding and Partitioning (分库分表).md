...
> [!note] 本节重点：分库分表策略（水平/垂直拆分）、Sharding Key 选择、跨节点查询与分布式事务问题
...
> [!info]- 延伸阅读
> - 下一步：[13-MySQL and Redis Caching (MySQL 与 Redis 缓存)](/06-Data%20and%20Distributed%20(数据与分布式)/01-MySQL%20and%20SQL%20(MySQL%20与%20SQL)/13-MySQL%20and%20Redis%20Caching%20(MySQL%20与%20Redis%20缓存).md)
