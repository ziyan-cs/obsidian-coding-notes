...
> [!important] **核心考点**：C 风格数组与指针的关系、std::string 的操作与性能、C 字符串函数
...
数组类型的底层机制详见 → [Variables, Types & Operators (变量、类型与运算符)](/03-C++%20Programming%20(编程语言)/01-Basic%20Syntax%20(基础语法)/01-Variables,%20Types%20&%20Operators%20(变量、类型与运算符).md)
