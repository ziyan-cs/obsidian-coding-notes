...
> [!important] **核心考点**：C++20 协程是可暂停/恢复的函数、基于栈的无栈协程、与异步操作的天然结合
...
协程是 C++20 的核心新特性，详见 → [Modern C++ Overview (现代 C++ 特性总览)](/03-C++%20Programming%20(编程语言)/03-Modern%20C++%20(现代%20C++)/00-Modern%20C++%20Overview%20(现代%20C++%20特性总览).md)
