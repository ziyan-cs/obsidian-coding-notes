...
# 07-Synchronization and Deadlock (同步与死锁)
...
> [!note] 本节重点心考点：> 临界区与竞态条件、锁的实现（Peterson/硬件原子/自旋锁）、互斥锁 vs 自旋锁
...
> [!note] 本节重点心考点：信号量概念、P/V 操作、计数信号量 vs 二进制信号量、生产者消费者、读写者问题
...
> [!note] 本节重点心考点：死锁四条件、死锁预防/避免/检测/恢复、银行家算法、资源分配图
