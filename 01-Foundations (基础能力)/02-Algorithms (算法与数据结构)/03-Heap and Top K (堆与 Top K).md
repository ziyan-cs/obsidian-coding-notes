...
**03-Heap and Top K (堆与 Top K)**：先说明它解决的问题，再解释一个关键机制、一个边界条件，并用最小示例或真实项目验证。


## Heap and Top K (堆与 Top K)

> [!abstract] 核心考点：堆的 push/pop 操作、TopK 的堆解法 vs 快速选择、海量数据处理的堆思路
...
- 不看正文，说明 03-Heap and Top K (堆与 Top K) 的问题、核心机制与边界。
