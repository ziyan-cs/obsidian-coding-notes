...
## 24-Greedy and Interval Algorithms (贪心与区间算法)

> [!abstract] 核心考点：贪心局部最优推全局最优、排序预处理、区间调度、经典贪心问题证明思路
...
## 25-Sliding Window (滑动窗口)

> [!abstract] 核心考点：滑动窗口模板（可变长度/固定长度）、窗口收缩条件判断、哈希表维护字符频次
