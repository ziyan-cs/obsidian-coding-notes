...
> [!note] 本节重点：贪心局部最优推全局最优、排序预处理、区间调度、经典贪心问题证明思路
...
> [!note] 本节重点：滑动窗口模板（可变长度/固定长度）、窗口收缩条件判断、哈希表维护字符频次
...
- 下一步：[11-String and Bit Algorithms (字符串与位运算)](/01-Foundations%20(基础能力)/02-Algorithms%20(算法与数据结构)/11-String%20and%20Bit%20Algorithms%20(字符串与位运算).md)
