...
> [!note] 本节重点： 分布式事务方案（2PC/XA、TCC、Saga、本地消息表）、Seata AT 模式、CAP 权衡
...
> ---
>
> 分布式事务的 CAP 权衡与一致性模型详解见 → CAP Theorem & BASE Theory (CAP理论) · Consistency Models：Strong, Eventual (一致性模型)
