...
| #   | 题目             | 难度  | 笔记位置                                                                                                                                                                            |
| --- | -------------- | --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 61  | 进程 vs 线程 vs 协程 | ★   | [Process vs Thread](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/01-Process%20vs%20Thread（进程与线程⭐）.md)                                                                  |
| 62  | 上下文切换的成本       | ★★  | [Context Switching](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/02-Context%20Switching（上下文切换）.md)                                                                     |
| 63  | 虚拟内存解决了什么问题    | ★★  | [Virtual Memory](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/04-Memory%20Management（内存管理⭐）/01-Virtual%20Memory（虚拟内存）.md)                                              |
| 64  | 分页 vs 分段       | ★★  | [Paging & Segmentation](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/04-Memory%20Management（内存管理⭐）/02-Paging%20&%20Segmentation（分页与分段）.md)                             |
...
| 66  | 死锁的四个条件和解决方案   | ★★  | [Deadlock](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/05-Synchronization（同步与互斥⭐）/03-Deadlock（死锁）.md)                                                                 |
| 67  | 互斥锁和信号量的本质区别   | ★   | [Mutex](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/05-Synchronization（同步与互斥⭐）/01-Mutex（互斥锁）.md)                                                                    |
| 68  | CPU 调度算法对比     | ★★  | [CPU Scheduling](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/03-CPU%20Scheduling（CPU调度）.md)                                                                         |
| 69  | 硬链接 vs 软链接     | ★   | [File System Basics](/01-CS%20Core%20(计算机核心基础)/03%20·%20Operating%20System（操作系统）/06-File%20System%20Basics（文件系统基础）.md)                                                              |
